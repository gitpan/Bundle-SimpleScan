# This Makefile is for the Bundle::SimpleScan extension to perl.
#
...
#     NAME => q[Bundle::SimpleScan]
#     VERSION_FROM => q[Bundle/SimpleScan.pm]
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = Bundle::SimpleScan
NAME_SYM = Bundle_SimpleScan
VERSION = 0.01
...
FULLEXT = Bundle/SimpleScan
BASEEXT = SimpleScan
PARENT_NAME = Bundle
DLBASE = $(BASEEXT)
VERSION_FROM = Bundle/SimpleScan.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
DISTNAME = Bundle-SimpleScan
DISTVNAME = Bundle-SimpleScan-0.01
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:         Bundle-SimpleScan' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:      0.01' >> META_new.yml
	$(NOECHO) $(ECHO) 'version_from: Bundle/SimpleScan.pm' >> META_new.yml
